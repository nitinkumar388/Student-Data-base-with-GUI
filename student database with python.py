...
class Student:
    def __init__(self,root):
        ...
        combo_search=ttk.Combobox(Detail_Frame,textvariable=self.search_by,font=("times new roman",13,'bold'),state='readonly',width=10)
        combo_search['values']=('Roll_No.','Name','Contact')
        combo_search.grid(row=0,column=1,padx=20,pady=10)

        txt_search=Entry(Detail_Frame,width=20,textvariable=self.search_text,font=("times new roman",10,'bold'),bd=5,relief=GROOVE)
